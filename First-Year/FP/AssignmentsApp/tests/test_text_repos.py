...
class StudentMemoRepoTestCase(unittest.TestCase):
    def setUp(self):
        self._reset_test_file('test_students.txt')
        self.repo = TextFileRepoStudent('test_students.txt')
...
class AssignmentMemoRepoTestCase(unittest.TestCase):
    def setUp(self):
        self._reset_test_file('test_assignments.txt')
        self.repo = TextFileRepoAssignment('test_assignments.txt')
